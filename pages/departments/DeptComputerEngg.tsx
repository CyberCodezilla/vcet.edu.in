    ...
    <PageLayout>
      ...
      <div className="container mx-auto px-6 py-12 max-w-7xl flex flex-col lg:flex-row gap-10">
        ...
        <main className="w-full lg:w-3/4 space-y-16">
          ...
          {activeId === 'faculty' && (() => {
            const faculty = [
              { name: 'Dr. Megha Trivedi', post: 'HOD & Associate Professor', email: 'megha.trivedi@vcet.edu.in', photo: '/Images/departments/comp/faculty/dr-megha-trivedi.jpg', initials: 'MT', color: '#1a4b7c' },
            ];
            return (
              <div className="space-y-10">
                <div className="reveal flex items-center justify-between flex-wrap gap-4 pb-5 border-b-2 border-brand-gold/30">
                  ...
                  <div className="flex items-center divide-x divide-slate-200">
                    {[
                      ...
                      { icon: 'ph-trophy', value: '25+', label: 'Yrs Exp.' },
                    ].map(stat => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-4">
                  {faculty.map((f) => (
                    <div key={f.email} className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100 border-t-[3px] border-b-[3px] border-t-[#1a4b7c] border-b-[#fdb813] flex flex-col items-center px-6 pt-6 pb-5">
                      <div className="relative w-32 h-36 mb-4 shrink-0">
                        ...
                        <div className="absolute inset-0 hidden items-center justify-center text-white font-bold text-2xl" style={{ background: f.color }}>{f.initials}</div>
                ...
                <div className="reveal bg-brand-navylight rounded-2xl p-6 flex items-center gap-4 border border-brand-navy/10">
                  ...
                  <p className="text-sm text-brand-navy/70">
                    ...
                    <a href="mailto:computer-engineering@vcet.edu.in" className="underline font-semibold">computer-engineering@vcet.edu.in</a> for more information.
                  </p>
                </div>
              </div>
            );
